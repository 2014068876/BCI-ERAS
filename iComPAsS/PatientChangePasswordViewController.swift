//
//  PatientChangePasswordViewController.swift
//  iComPAsS
//
...
class PatientChangePasswordViewController: UIViewController {
    ...
    @IBAction func changePassword(sender: UIButton) {
        if let old = self.oldPass.text, new = self.newPass.text, confirm = self.validateNewPass.text {
            ...
            if old == "" || new == "" || confirm == "" {
                self.labelPasswordError.text = "Kindly fill up all the fields, thank you."
                self.labelPasswordError.hidden = false
                ...
                self.labelPasswordError.hidden = true
                updateAllFieldsColor()
                ...
                if new == confirm {
                    ...
                    self.labelPasswordError.text = "Password does not match."
                    self.labelPasswordError.hidden = false
                    self.newPass.layer.borderColor = UIColor.redColor().CGColor
                    self.validateNewPass.layer.borderColor = UIColor.redColor().CGColor
                }
